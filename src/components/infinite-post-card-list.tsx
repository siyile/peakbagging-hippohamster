...
// Search only. The three static feeds render every post server-side via
// PostCardList — see the note there for why paging them was the bug rather
// than the feature. Search keeps it because its result count is unbounded and
